              ...
              <ScrollView contentContainerStyle={styles.indicatorscroll} keyboardShouldPersistTaps="always">
                ...
                <KeyboardAvoidingView>
                  <View style={this._checkSubmition("passctn")}>
                    <TextInput secureTextEntry placeholder={intl.get('Common.NewPassword')} style={Config.passinput} placeholderTextColor="#fff"
                      onChangeText={(text) => this.setState({ passwordinput: text })} secureTextEntry={this.state.showhidepassword }/>
                  ...
                  <TextInput secureTextEntry placeholder={intl.get('Common.ConfirmNewPassword')} style={this._checkSubmition("pass")} placeholderTextColor="#fff"
                    onChangeText={(text) => this.setState({ retypepasswordinput: text })} secureTextEntry={this.state.showhidepassword }/>
                </KeyboardAvoidingView>
