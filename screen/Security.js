      ...
      <SafeAreaView style={styles.container}>
        ...
        <LinearGradient colors={Color.gradientColor} style={Config.linearGradient}>
          ...
          <View style={styles.bottomnoticectn}>
            ...
            <Text style={[styles.greytt,{marginTop:-1}]}>{intl.get('Scurity.TransactionVerification.Notice',{total:this.props.settingStore.settings.security.selectedlist.length})}</Text>
          </View>
        </LinearGradient>
      </SafeAreaView>
    );
